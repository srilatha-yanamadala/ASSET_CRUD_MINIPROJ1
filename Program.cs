...
namespace AsssetTracking.ConsoleApp
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("\n Please enter your Asset type (Computer/mobile)::press q for exit.");
                   ...
                   (Assettype.Trim().ToUpper().Equals("LAPTOP") || Assettype.Trim().ToUpper().Equals("MOBILE")))
                {
                    ...
                    while (!Model.Trim().ToUpper().Equals("Q"))
                    {
                        ...
                        {
                           Console.WriteLine($"Enter the {Model} PRICE in USD $ :");
                           double  PurchasePrice = double.Parse(Console.ReadLine());
                           Console.WriteLine($"Enter the {Model} PURCHASE DATE (yyyy-mm-dd) :");
                           ...
                           if (Assettype.ToUpper().Equals("LAPTOP") || Assettype.ToUpper().Equals("MOBILE"))
                           {
                               ...
                               AddComputer(Assettype,"DELL", Model, PurchaseDate, office, PurchasePrice, currency, exchangeRate);
                           }                                
                           else
        ...
        public static void AddComputer(String AssetType,String brandName, String modelName,DateTime dateOfPurchase,
        ...
        static void printDetails(Asset a,int Id)
        {
            ...
            Console.WriteLine("\t YOUR PURCHASE PRICE IS::" + a.PurchasePrice.ToString());
